...
const svgDotes = document.querySelectorAll<HTMLElement>(".svg-dotes");

const modal = document.getElementById("modal") as HTMLElement;

const reportBtn = document.getElementById("reportBtn") as HTMLElement;
...
const messageBtn = document.getElementById("messageBtn") as HTMLElement;

const chat = document.getElementById("chat") as HTMLElement;

const messageClose = document.querySelector(".message-close") as HTMLElement;

const toDo = document.getElementById("toDo") as HTMLElement;

const edit = document.querySelector(".edit") as HTMLElement;

const messageCloseBtn = document.querySelector(
  ".message-close-btn"
) as HTMLElement;

const goback = document.querySelector(".goback") as HTMLElement;
...
const metaContainer = document.getElementById("metaContainer") as HTMLElement;

const search = document.querySelector(".search") as HTMLElement;

const svgs = document.querySelectorAll<HTMLElement>("svg");
...
const postImages = document.querySelectorAll<HTMLElement>(".post-main-image");
...
postImages.forEach((image) => {
  image.addEventListener("dblclick", () => {
    const heart = image.querySelector(".heart-effect") as HTMLElement;
...
function setTheme(mode: any): any {
  if (mode === "dark") {
...
theme.addEventListener("click", (e): void => {
  e.preventDefault();
...
document.querySelectorAll(".post-main").forEach((post): void => {
  const imgDiv = post.querySelector(".post-main-image");
  const heart = post.querySelector(".heart-svg") as HTMLElement;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateChatButtonState() {
    const checkedCount = document.querySelectorAll<HTMLElement>(
  ...
  function removeChip(contactName: any): any {
  ...
  function deselectContact(contactName: any): any {
  ...
  function addChip(contactName: any) {
    ...
    const removeBtn = chip.querySelector(".remove-contact");
    if (removeBtn) {
...
document.addEventListener("click", (e) => {
  ...
  const isClickInside = menuContainer.contains(target) || more.contains(target);
...
document.addEventListener("click", (e: MouseEvent) => {
  const target = e.target as Node;
  const isClickInsideMeta =
    metaContainer.contains(target) || meta.contains(target);
